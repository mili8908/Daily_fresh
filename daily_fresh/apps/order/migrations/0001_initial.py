    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_method', models.SmallIntegerField(verbose_name='付款方式', default=1, choices=[(1, '货到付款'), (2, '微信支付'), (3, '支付宝'), (4, '银联支付')])),
                ...
                ('order_status', models.SmallIntegerField(verbose_name='订单状态', default=1)),
